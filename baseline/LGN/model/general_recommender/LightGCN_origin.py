...
class LightGCN(AbstractRecommender):
    ...
    def _create_lightgcn_embed(self):
        ...
        for k in range(0, self.n_layers):
            ...
            #except:
            dense_adj_mat = tf.sparse_tensor_to_dense(adj_mat)
            dense_ego_embeddings = tf.sparse_tensor_to_dense(ego_embeddings)
            side_embeddings = tf.matmul(dense_adj_mat, dense_ego_embeddings, a_is_sparse = True, b_is_sparse = True)
