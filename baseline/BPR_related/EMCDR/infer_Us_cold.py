...
cold_users_array = []
with open('../lfm_bpr_graphs/' + args.dataset_name.split('_')[0] + '_' + f'lightfm_bpr_{args.current_epoch}_10e-5.txt', 'r') as f:
    for line in f:
        line = line.strip("\n")
...
# save
with open('./' + args.dataset_name + f'/cold_users_mapped_emb_dict_{args.current_epoch}.pickle', 'wb') as pf:
