...
class WRMF(AbstractRecommender):
    ...
    def _create_optimizer(self):    
        ...
        self.update_user = tf.compat.v1.scatter_update(self.user_embeddings, self.user_id, tf.transpose(a=xu))
        ...
        self.update_item = tf.compat.v1.scatter_update(self.item_embeddings, self.item_id, tf.transpose(a=xi))
